...
function FixFloorAction:isValid()
  local playerInv = self.character:getInventory()
    print(playerInv:contains("Hammer"))
  return (
    playerInv:contains("Hammer") or
    playerInv:contains("HammerForged") or
    playerInv:contains("BallPeenHammer") or
    playerInv:contains("BallPeenHammerForged") or
    playerInv:contains("ClubHammer") or
    playerInv:contains("ClubHammerForged") or
    playerInv:contains("SmithingHammer") or
    playerInv:contains("HammerStone")
  );
end
